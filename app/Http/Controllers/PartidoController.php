...
class PartidoController extends Controller
{
    ...
    // Los controles de carga (alineaciones, goles, tarjetas, cambios,
    // arbitros, tecnicos) se fueron a App\Services\Controles y a
    // ControlController: eran siete metodos que repetian el mismo SELECT
    // con los mismos cinco JOIN y devolvian dos a cuatro paginadores por
    // pantalla, aunque solo se mirara una pestania.
