                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-10">
                        <div class="form-group">
                            ...
                            <a href="{{route('equipos.ver', array('equipoId' => $equipo->id))}}" ><strong>{{$equipo->nombre}} <img id="original" src="{{ url('images/'.removeAccents($equipo->pais).'.gif') }}" alt="{{ $equipo->pais }}"></strong></a>
