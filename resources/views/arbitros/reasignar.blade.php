...
@section('pageTitle', 'Reasignar arbitro')
...
@section('content')
    <div class="container">
        ...
        {{ Form::open(['action' => ['ArbitroController@guardarReasignar'], 'method' => 'put']) }}
        <!-- Include the CRSF token -->
        {{Form::token()}}
            <!-- build our form inputs -->
            <input type="hidden" id="arbitroId" name="arbitroId" value="{{$arbitro->id}}">
    <h1 class="display-6">Reasignar arbitro</h1>
            ...
            <table class="table" style="width: 60%">
                ...
                <tbody id="cuerpoReasignar">
                    ...
                    <tr>
                        ...
                        <td>{{ Form::select('arbitro_id',$arbitros, '',['class' => 'form-control js-example-basic-single', 'style' => 'width: 300px']) }}</td>
