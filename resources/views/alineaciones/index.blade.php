...
@section('content')
    <div class="container">
        ...
        <!-- Local and Visitante side by side -->
        <div class="row">
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($titularesL ?? '' as $titularl)
                            <tr>
                                ...
                                <td>{{ Form::select('titularl[]',$jugadorsL, $titularl->jugador->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($suplentesL ?? '' as $suplentel)
                            <tr>
                                ...
                                <td>{{ Form::select('suplentel[]',$jugadorsL, $suplentel->jugador->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($partidoTecnicosL ?? '' as $partidoTecnicoL)
                            <tr>
                                ...
                                <td>{{ Form::select('tecnicoL[]',$tecnicos, $partidoTecnicoL->tecnico->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($titularesV ?? '' as $titularv)
                            <tr>
                                ...
                                <td>{{ Form::select('titularv[]',$jugadorsV, $titularv->jugador->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($suplentesV ?? '' as $suplentev)
                            <tr>
                                ...
                                <td>{{ Form::select('suplentev[]',$jugadorsV, $suplentev->jugador->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        @foreach($partidoTecnicosV ?? '' as $partidoTecnicoV)
                            <tr>
                                ...
                                <td>{{ Form::select('tecnicoV[]',$tecnicos, $partidoTecnicoV->tecnico->id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%']) }}</td>
