                ...
                <table class="table" style="width: 60%">
                    ...
                    @foreach($penales ?? '' as $penal)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($penal->jugador->persona->foto)
                                    <img id="original" class="imgCircle" src="{{ url('images/'.$penal->jugador->persona->foto) }}" >
                                @else
