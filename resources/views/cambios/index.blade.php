...
@section('pageTitle', 'Sustituciones')
...
@section('content')
    ...
    {{ Form::open(['action' => ['CambioController@update', (isset($_GET['partidoId']))?$_GET['partidoId']:''], 'method' => 'put']) }}
    ...
    <!-- build our form inputs -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12">
                <h1 class="display-6">Sustituciones</h1>
                    ...
                    @foreach($cambios ?? '' as $cambio)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                {{Form::hidden('cambio_id[]',$cambio->id)}}
                            </td>
