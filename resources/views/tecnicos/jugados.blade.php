...
@section('pageTitle', 'Partidos dirigidos')
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-10">
                        <div class="form-group">
                            ...
                            <a href="{{route('tecnicos.ver', array('tecnicoId' => $tecnico->id))}}" ><strong>{{$tecnico->persona->getFullNameAgeAttribute()}}</strong></a>
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-8" id="detalle">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-3">
                        @if($torneo)
                            <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'torneoId' => $torneo->id))}}" >
                                @else
                                    <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id))}}" >
                                        @endif
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-3">
                        @if($torneo!='')
                            <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'torneoId' => $torneo->id,'tipo' => 'Ganados'))}}" >
                                @else
                                    <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'tipo' => 'Ganados'))}}" >
                                        @endif
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-3">
                        @if($torneo!='')
                            <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'torneoId' => $torneo->id,'tipo' => 'Empatados'))}}" >
                                @else
                                    <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'tipo' => 'Empatados'))}}" >
                                        @endif
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-3">
                        @if($torneo!='')
                            <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'torneoId' => $torneo->id,'tipo' => 'Perdidos'))}}" >
                                @else
                                    <a href="{{route('tecnicos.jugados', array('tecnicoId' => $tecnico->id,'tipo' => 'Perdidos'))}}" >
                                        @endif
