    ...
    @section('content')
        ...
        <!-- build our form inputs -->
            ...
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6 col-md-6 mt-2">
                    {{ Form::label('url3', 'URL livefutbol.com (opcional)') }}
                    {{ Form::text('url3', '', ['class' => 'form-control', 'placeholder' => 'https://www.livefutbol.com/match-report/...']) }}
                </div>
            </div>
